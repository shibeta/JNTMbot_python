...
- ✅ 确保没有开启 **[Windows 自动 HDR](https://go.microsoft.com/fwlink/?linkid=2159313)** 。或者，在 **Windows 设置 > 系统 > 屏幕 > 显示卡** 中单独关闭 GTA5 的自动 HDR。
- ✅ 确保将 **Steam 设置 > 通知 > 显示弹出通知...** 设置为 **从不** (会和窗口内容识别冲突)。
- ✅ 确保将 **Steam 设置 > 游戏中 > 显示性能监视器** 设置为 **关闭** 。或者，将 **Steam 库 > GRAND THEFT AUTO V 增强版 > 属性 > 通用 > 在游戏中启用 Steam 叠加界面** 设置为 **关闭** (会和窗口内容识别冲突)。
